...
module Ecm
  module Faq
    describe Category do
      subject { Factory.create(:ecm_faq_category) }
      
      context "associations" do
        it { should have_many(:ecm_faq_items) }
      end
      ...
      context "acts as markup" do
        subject { 
          Factory.create(:ecm_faq_category, 
      ...
      context "acts as tree" do
        ...
        it "should not accept a locale if it is not a root node" do
          product_category = FactoryGirl.create(:ecm_faq_category_with_parent)
      ...
      context "friendly id" do
        subject { Factory.create(:ecm_faq_category, :name => 'Look, a slugged category!') }
